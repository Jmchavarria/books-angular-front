...
import { CreateCategoryDto } from '../../application/use-cases/create-category/create-category.dto';
...
export class CategoriesComponent implements OnInit {
  ...
  openModal() {
    ...
    const emptyCategory = this.getEmptyForm();

    this.categoriesform.reset({
      name: emptyCategory.name,
      description: emptyCategory.description,
    });
  ...
  private getEmptyForm(): CreateCategoryDto {
    return {
      name: '',
      description: '',
    };
